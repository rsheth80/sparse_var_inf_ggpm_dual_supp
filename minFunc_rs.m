function [x,f,exitflag,output] = minFunc_rs(funObj,x0,options,varargin)
% [x,f,exitflag,output] = minFunc_rs(funObj,x0,options,varargin)
%
...
%
% EDIT: RS - 8/22/14
%   * Provided option to supply a step size bounding function that computes the
%   maximum step size allowed for opts.StepFunc which takes the current
%   solution, descent direction, and current step size as arguments
...
[verbose,verboseI,debug,doPlot,maxFunEvals,maxIter,optTol,progTol,method,...
    ...
    Damped,HvFunc,bbType,cycle,...
    HessianIter,outputFcn,useMex,useNegCurv,precFunc,...
    LS_type,LS_interp,LS_multi,checkGrad,StepFunc,btbeta] = ...
    minFunc_processInputOptions_rs(options);
% EDIT: RS - 8/22/14
...
% EDIT: RS - 8/22/14
    if ~isempty(StepFunc) && i ~= 1 % treat first step specially
        % User-supplied function to compute maximum step-length
        max_step_size = StepFunc(x,d,t);
    else
        max_step_size = inf;
    end;
% EDIT: RS - 8/22/14
...
%             [t,x,f,g,LSfunEvals,H] = ArmijoBacktrack(x,t,d,f,fr,g,gtd,c1,LS_interp,LS_multi,progTol,debug,doPlot,LS_saveHessianComp,funObj,varargin{:});
            [t,x,f,g,LSfunEvals,H] = ArmijoBacktrack_rs1(x,t,d,f,fr,g,gtd,c1,LS_interp,LS_multi,progTol,debug,doPlot,LS_saveHessianComp,btbeta,max_step_size,funObj,varargin{:});
% EDIT: RS - 8/22/14
        else
% EDIT: RS - 8/22/14
%             [t,x,f,g,LSfunEvals] = ArmijoBacktrack(x,t,d,f,fr,g,gtd,c1,LS_interp,LS_multi,progTol,debug,doPlot,1,funObj,varargin{:});
            [t,x,f,g,LSfunEvals] = ArmijoBacktrack_rs1(x,t,d,f,fr,g,gtd,c1,LS_interp,LS_multi,progTol,debug,doPlot,1,btbeta,max_step_size,funObj,varargin{:});
% EDIT: RS - 8/22/14
        end
...
%             [t,f,g,LSfunEvals,H] = WolfeLineSearch(x,t,d,f,g,gtd,c1,c2,LS_interp,LS_multi,25,progTol,debug,doPlot,LS_saveHessianComp,funObj,varargin{:});
            [t,f,g,LSfunEvals,H] = WolfeLineSearch_rs1(x,t,d,f,g,gtd,c1,c2,LS_interp,LS_multi,25,progTol,debug,doPlot,LS_saveHessianComp,btbeta,max_step_size,funObj,varargin{:});
% EDIT: RS - 8/22/14
        else
% EDIT: RS - 8/22/14
%             [t,f,g,LSfunEvals] = WolfeLineSearch(x,t,d,f,g,gtd,c1,c2,LS_interp,LS_multi,25,progTol,debug,doPlot,1,funObj,varargin{:});
            [t,f,g,LSfunEvals] = WolfeLineSearch_rs1(x,t,d,f,g,gtd,c1,c2,LS_interp,LS_multi,25,progTol,debug,doPlot,1,btbeta,max_step_size,funObj,varargin{:});
% EDIT: RS - 8/22/14
        end
        funEvals = funEvals + LSfunEvals;
        x = x + t*d;
