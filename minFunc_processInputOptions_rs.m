...
function [verbose,verboseI,debug,doPlot,maxFunEvals,maxIter,optTol,progTol,method,...
    ...
    LS_type,LS_interp,LS_multi,DerivativeCheck,StepFunc,btbeta] = ...
    minFunc_processInputOptions_rs(o)

% EDIT: RS - 8/22/14
%   * Added program option to include user-supplied function for computing
%   step length: 'StepFunc' field of opts
...
% EDIT: RS - 8/22/14
StepFunc = getOpt(o,'STEPFUNC',[]);
btbeta = getOpt(o,'BTBETA',0.5);
% EDIT: RS - 8/22/14
end
